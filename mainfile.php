...
if (!defined('API_MAINFILE_INCLUDED')) {
    ...
    define('API_PATH', '/fonts/xoops_data/caches/webdav');
    ...
    // Example: define('API_URL', 'http://fonty.localhost');
    define('API_URL', 'https://dav.fonts4web.org.uk');
    ...
    define('API_COOKIE_DOMAIN', 'dav.fonts4web.org.uk');
